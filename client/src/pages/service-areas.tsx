...
import { CANONICAL_CITY_PAGES } from "@/data/city-pages";
      ...
      <div className="container mx-auto px-4 py-20">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {CANONICAL_CITY_PAGES.map((city) => (
              <Link key={city.path} href={city.path} className="flex items-center gap-3 p-4 bg-white border border-slate-200 rounded-xl hover:border-primary hover:shadow-lg hover:-translate-y-1 transition-all group">
                  ...
                  <span className="font-semibold text-slate-700 group-hover:text-slate-900">{city.name}</span>
              </Link>
            ))}
          </div>
        </div>
