...
import {
  ...
  Smartphone, Droplets, ShieldCheck, Flame, Zap, X,
} from "lucide-react";

/* ─── Category selector ID mapping ─── */
...
const HEATING_SPECIALTIES = [
  ...
  { label: "Floor Furnace Services", desc: "Installation, repair & cleaning" },
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto p-0">
        ...
        <div className="p-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3 pt-4 border-t border-slate-100">
            <Button className="flex-1 bg-primary hover:bg-primary/90 font-semibold" asChild>
            ...
            <Button variant="outline" size="icon" className="border-secondary/20 text-secondary hover:bg-secondary/5 shrink-0" asChild>
    ...
    <Layout>
      ...
      <section className="bg-gradient-to-br from-primary via-blue-700 to-blue-900 text-white py-16 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Button size="lg" className="bg-secondary hover:bg-secondary/90 text-white font-bold px-8" asChild>
      ...
      <section className="py-12 bg-slate-50 min-h-[500px]">
        <div className="container mx-auto px-4">
          ...
          {/* HVAC-specific extras */}
          {activeCategory === "HVAC & Heating" && (
            <>
              {/* Heating Specialties */}
              <div className="mb-10">
                <h2 className="text-xl font-bold text-slate-900 mb-1">Heating Specialties</h2>
                <p className="text-sm text-slate-500 mb-5">Expert furnace and heating system services across Los Angeles</p>
                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3">
                  {HEATING_SPECIALTIES.map(({ label, desc }) => (
                    <div
                      key={label}
                      className="bg-white border border-slate-100 rounded-xl p-4 text-center shadow-sm hover:shadow-md hover:border-primary/20 transition-all cursor-default"
                    >
          ...
          {/* Smart Irrigation Info (Outdoor category) */}
          {activeCategory === "Outdoor & Property" && (
            <div className="mt-12 bg-gradient-to-br from-blue-50 to-green-50 rounded-2xl p-8 md:p-10 border border-blue-100 shadow-sm">
              <div className="flex items-center gap-3 mb-5">
                ...
                <h3 className="text-xl font-bold text-slate-900">Smart Irrigation & Smart Valve Technology</h3>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                {[
                  { icon: Smartphone, title: "Mobile Monitoring", desc: "Control irrigation and water shutoff from your smartphone, anywhere." },
                  { icon: Droplets,   title: "Leak Detection",    desc: "Smart sensors detect leaks instantly and shut off water automatically." },
                  { icon: ShieldCheck,title: "Insurance Discounts",desc: "Many insurers offer discounts for smart water monitoring devices." },
                  { icon: DollarSign, title: "Save on Water Bills",desc: "Intelligent scheduling and zone control reduces water waste." },
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <Button variant="outline" className="border-primary/20 text-primary hover:bg-primary/5" asChild>
                  <a href={getWhatsAppLink("Hi, I'd like to learn more about smart irrigation and smart valve technology.")} target="_blank" rel="noopener noreferrer">
      ...
      <section className="py-14 bg-blue-50 border-y border-blue-100">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-6">
            <span className="text-secondary text-xs font-semibold uppercase tracking-widest">Payment Options</span>
            <h2 className="text-2xl md:text-3xl font-bold text-slate-900 mt-2">Flexible Financing Available</h2>
            <p className="text-slate-500 mt-2 text-sm">Get the service you need today — pay over time.</p>
          </div>
          <p className="text-slate-600 text-sm leading-relaxed text-center max-w-2xl mx-auto mb-8">
            We understand that home repairs and upgrades can be unexpected. That's why BERNARDINO MARTIN offers
            flexible financing options to qualified customers. Whether you're replacing your HVAC system, installing
            solar, or upgrading your plumbing, we can help you find a payment plan that works for your budget.
            Apply in minutes with no hard credit pull required.
          </p>
          <div className="flex flex-wrap justify-center gap-3 mb-8">
            {["0% Interest Promotions", "Quick Approval Process", "Flexible Monthly Payments"].map((item) => (
              <div key={item} className="flex items-center gap-2 bg-white border border-blue-200 text-blue-800 text-sm font-semibold px-4 py-2 rounded-full shadow-sm">
                <Check className="h-4 w-4 text-primary" /> {item}
              </div>
            ))}
          </div>
          <div className="text-center">
            <Button size="lg" className="bg-primary hover:bg-primary/90 font-bold px-8" asChild>
