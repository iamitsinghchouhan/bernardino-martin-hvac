...
import { CANONICAL_CITY_PAGES, CITY_PAGE_LINKS_BY_NAME } from "@/data/city-pages";
import {
  Droplets,
  Fan,
  Flame,
...
export const PROMOS = [
  {
    title: "$79 DIAGNOSTIC",
    sub: "Fast same-day troubleshooting",
    description: "Book a professional HVAC or plumbing diagnostic visit with clear next-step recommendations.",
    code: "DIAG79",
  },
  {
    title: "$89 OFF",
...
export const SERVICES: Service[] = [
  {
    ...
    duration: "1-3 hours",
    image: "/images/svc-hvac-repair-new.webp",
    icon: Wrench,
  ...
  },
  {
    ...
    price: "Free estimate",
    duration: "4-8 hours",
    image: "/images/svc-hvac-install-new.webp",
    icon: Wind,
    category: "HVAC & Heating",
    categoryId: "hvac",
  },
  {
    ...
    duration: "1-2 hours",
    image: "/images/svc-hvac-maintenance-new.webp",
    icon: Settings,
    category: "HVAC & Heating",
    categoryId: "hvac",
  },
  {
    ...
    duration: "4-6 hours",
    image: "/images/svc-ductless-new.webp",
    icon: Thermometer,
    category: "HVAC & Heating",
    categoryId: "hvac",
  },
  {
    ...
    duration: "3-6 hours",
    image: "/images/svc-ducts-new.webp",
    icon: Fan,
    category: "HVAC & Heating",
    categoryId: "hvac",
  },
  {
    ...
    duration: "2-6 hours",
    image: "/images/svc-heating-new.webp",
    icon: Flame,
    category: "HVAC & Heating",
    categoryId: "hvac",
  },
  {
    ...
    duration: "1-2 hours",
    image: "/images/svc-thermostat-new.webp",
    icon: Settings,
    category: "HVAC & Heating",
    categoryId: "hvac",
  },
  {
    ...
    price: "Free estimate",
    duration: "1-2 days",
    image: "/images/svc-solar-install-new.webp",
    icon: Sun,
  ...
  },
  {
    ...
    duration: "2-4 hours",
    image: "/images/svc-solar-maintenance-new.webp",
    icon: Zap,
    category: "Solar & Energy",
    categoryId: "solar",
  },
  {
    ...
    duration: "3-5 hours",
    image: "/images/svc-solar-irrigation-new.webp",
    icon: Sprout,
    category: "Solar & Energy",
    categoryId: "solar",
  },
  ...
  },
  {
    ...
    price: "Starting at $199",
    duration: "4-8 hours",
    image: "/images/services/electrical-hero.webp",
    icon: Plug,
    category: "Electrical",
  ...
  },
  {
    ...
    description: "Outlets, switches, lighting, EV charging, and full home wiring",
    overview:
      "From adding an outlet to rewiring an entire room, our electricians handle all residential electrical needs. We also install EV chargers, dedicated circuits, and smart home wiring upgrades with a clean, code-compliant finish.",
    bullets: [
    ...
    price: "Starting at $99",
    duration: "1-6 hours",
    image: "/images/services/electrical-ev-charger.webp",
    icon: Zap,
    category: "Electrical",
    categoryId: "electrical",
  },
  {
    ...
    price: "Free estimate",
    duration: "1-5 days",
    image: "/images/svc-landscaping.webp",
    icon: TreePine,
  ...
  },
  {
    ...
    duration: "1-2 days",
    image: "/images/svc-sod-installation.webp",
    icon: Sprout,
    category: "Outdoor & Property",
    categoryId: "outdoor",
  },
  {
    ...
    price: "Starting at $149",
    duration: "2-6 hours",
    image: "/images/svc-planting.webp",
    icon: Flower2,
    category: "Outdoor & Property",
    categoryId: "outdoor",
  },
  {
    ...
    description: "App-controlled irrigation for lawns, gardens, planters, and efficient water savings",
    overview:
      "We design and install smart irrigation systems that give homeowners better control over water use, plant health, and outdoor maintenance. From smartphone scheduling and drip zones to sprinkler upgrades and shutoff protection, our systems are built for Los Angeles landscapes that need precision instead of guesswork.",
    bullets: [
      "Smartphone app scheduling",
      "Drip irrigation and sprinkler zones",
      "Controller upgrades and repairs",
      "Smart shutoff valve protection",
      "Water usage monitoring",
      "Seasonal watering optimization",
    ],
    price: "Starting at $499",
    duration: "3-6 hours",
    image: "/images/services/irrigation-hero.webp",
    icon: Sprout,
    category: "Outdoor & Property",
    categoryId: "outdoor",
  },
  {
    ...
    price: "Starting at $199",
    duration: "2-6 hours",
    image: "/images/services/network-panel.webp",
    icon: Wifi,
    category: "Technology",
  ...
  },
  {
    ...
    description: "Connect and automate your home's devices with a clean, reliable setup",
    overview:
      "We integrate smart home devices including lighting, thermostats, security cameras, media systems, and app-controlled devices into one reliable home network. The result is a cleaner install, stronger connectivity, and easier control from your phone or voice assistant.",
    bullets: [
    ...
    price: "Starting at $149",
    duration: "2-4 hours",
    image: "/images/services/network-smarthome.webp",
    icon: Wifi,
    category: "Technology",
    categoryId: "technology",
  },
  {
    ...
    duration: "3-6 hours",
    image: "/images/services/smart-network-solutions.webp",
    icon: Wifi,
    category: "Technology",
    categoryId: "technology",
  },
...
export const CITIES = CANONICAL_CITY_PAGES.map((city) => city.name);
